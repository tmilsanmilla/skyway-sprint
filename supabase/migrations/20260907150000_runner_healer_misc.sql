...
with finished_abilities(
  ...
  values
    ...
    ('runner_stride','common','Pace Blades',
      'Every third lane change grants a brief dodge shield.',
      'Adds 3% distance score.'),
    ...
    ('runner_blitz','rare','Volt Cleats',
      'Can dash and destroy the first non-rock obstacle ahead.',
      'Adds 5% distance score.'),
    ...
    ('medic_suture','epic','Pulse Thread',
      'Restores to full every third wave; otherwise heals 1 HP only every second wave.',
      'Adds 6% distance score.'),
    ('medic_beacon','epic','Rescue Lamp',
      'At 1 HP, glows, disables spikes, and slows all obstacles by 50%.',
      'Adds 6% distance score.'),
